# Inbox Architect Agent — User Guide
...
See [apps-script.md](apps-script.md) for details.
...
- [classification-guide.md](classification-guide.md) — Categories, tags, and smart detection
- [operations-guide.md](operations-guide.md) — Learning loop, commands, monitoring, performance
- [architecture.md](architecture.md) — Plugins, pipeline, and local intelligence internals
